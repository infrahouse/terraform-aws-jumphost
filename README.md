...
| <a name="input_nlb_internal"></a> [nlb\_internal](#input\_nlb\_internal) | If true, the load balancer's DNS name will resolve into internal IP addresses. | `bool` | `false` | no |
